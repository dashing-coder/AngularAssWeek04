...
export class LandingComponent implements OnInit {
  public studentTitle = 'All Student';
  public teacherTitle = 'All Teacher';

  public studentList: Card[] = [];
  public teacherList: Card[] = [];

  constructor(private studentService: StudentService, private teacherService: TeacherService, private titleService: Title) {
    this.titleService.setTitle('Welcome to home');
    this.setStudentList();
    this.setTeacherList();
  }
